...
class TestPetApi:
    ...
    def test_post_pet_valid_data(self, create_pet):
        ...
        print(f"✅ Test passed: Pet added successfully with {pet['id']}")
    ...
    def test_post_pet_invalid_data(self):
        ...
        print("✅ Test passed: Proper error code is returned")
    ...
    def test_get_pet_valid_pet_id(self, create_pet):
        ...
        while time.time() - start_time < MAX_WAIT_SECONDS:
            ...
            if response_get.status_code == 200:
                print("Record found:", response_get.json())
                break
            time.sleep(POLL_INTERVAL)
        else:
            raise AssertionError(f"Record {pet['id']} was not available within {MAX_WAIT_SECONDS} seconds")

        assert response_get.status_code == 200, f"Unexpected status code: {response_get.status_code}"
        data = response_get.json()
        assert data["id"] == pet["id"]
        assert data["name"] == pet["name"]
        print(f"✅ Test passed: Pet returned successfully with {data['id']}")
    ...
    def test_get_pet_invalid_pet_id(self):
        ...
        print(f"✅ Test passed: Proper error message and code is returned")
    ...
    def test_get_pet_by_valid_status(self, status, create_pet):
        ...
        for pet_in_response in data:
            if pet_in_response["id"] == pet["id"]:
                ...
                print(f"✅ Test passed: Pet returned successfully with {pet_in_response['id']}")
    ...
    def test_upload_image_with_valid_pet_id(self, create_pet):
        ...
        files = {
            'file': ('premium_photo-1694819488591-a43907d1c5cc.jpeg',
                     open('../core/test_data/premium_photo-1694819488591-a43907d1c5cc.jpeg', 'rb'), 'image/jpeg')
        }
        data = {
    ...
    def test_upload_image_with_invalid_pet_id(self):
        ...
        Expects HTTP 404 Not Found.
        """
        file_path = os.path.abspath('../core/test_data/premium_photo-1694819488591-a43907d1c5cc.jpeg')
